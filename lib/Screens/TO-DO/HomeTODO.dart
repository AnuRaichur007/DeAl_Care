          ...
          Column(
            ...
            children: [
              AppBar(
                ...
                elevation: 0,
                title: Center(
                  child: Text("Schedular", style: TextStyle(
                      fontSize: 20
                  ),),
                ),
                actions: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          height: 4,
                          width: 120,
                          color: (filterType== "today")?Colors.teal.shade300:Colors.transparent,
                        )
                      ],
                    ),
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          height: 4,
                          width: 120,
                          color: (filterType == "monthly")?Colors.teal.shade300:Colors.transparent,
                        )
                      ],
                    )
                  ],
